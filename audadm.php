...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Auditoría de Administrador</h1>
<?php

    $conn = oci_connect("invetpc","1234","//localhost/xe");
    $stmt = oci_parse($conn, "select * from aud_tables");
    $r = oci_execute($stmt);
    $nrows = oci_fetch_all($stmt, $results);
    if($nrows>0){
        echo "<table border><tr><th>Transacción</th><th>Tipo</th><th>Fecha</th><th>Usuario que realizó el cambio</th><th>RUT</th><th>Nombre</th></tr>";
        for ($i = 0; $i < $nrows; $i++){
            echo "<tr>\n";
