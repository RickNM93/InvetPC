...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>Bienvenido a InvetPC</h1>
                <p>Seleccione alguna de las opciones de la barra de navegación superior, si desea ver los productos y su stock, ingrese a "Realizar Venta"</p>
            </div>
        </div>
    </div>
