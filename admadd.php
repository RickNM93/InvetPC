...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">    <!--FORMULARIO EN HTML PARA INGRESAR DATOS EN HTML-->
  ...
  <br><br>
  Rut: <input type="text" name="rut" value="<?php echo $rut;?>">

  <br><br>
  Contraseña: <input type="text" name="pass" value="<?php echo $pass;?>">
...
<?php
	...
	if ($nombre != ""){
		...
		$s = oci_parse($conn, "call pro_mant_administrador('C', :bid, :bds, :bps, :bml)");  //VARIABLE CON EL LLAMADO 'CALL' AL PROCEDIMIENTO, EN ESTE CASO VA CON UNA C YA QUE CON ESTA OPCION, SE CREAN DATOS EN LA TABLA
